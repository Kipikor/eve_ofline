...
- навыки, очередь до 150 пунктов, перенос пунктов вверх/вниз, абсолютная синхронизация Пилотов 03–10 с Пилотом 02, отдельная жизнь Пилота 01, планы по корпусам и грейдам, Small/Large Skill Injectors;
- добыча отдельными модулями, автоцель по оставшейся кубатуре, автовыгрузка, визуальный отварп `5+10+5`, persisted-подлёт боевых дронов к NPC и пассивная перезарядка щита онлайн/офлайн;
