...
- готовые заблокированные комплекты кораблей: бесплатная Venture T0 и платные Ore/Ice/Gas/Mercoxit/Booster T1/T2/ORE, встроенные shield-tank и боевые дроны;
...
- постоянный мир добычи и save schema v13: ежедневное пополнение статических белтов в `11:00 UTC`, отдельный жизненный цикл аномалий, грейды руды;
...
- офлайн-догон: обучение, добыча, подход, разгрузка, перелёты, автомаршрут, NPC, bursts/core и world lifecycle. Автопродажи нет; ISK офлайн не меняется. Корабельный догон ограничен 30 сутками, навыки и календарь догоняются полностью;
...
На момент handoff файл существовал, размер около 1.02 MiB. После установки игры его нужно вернуть в тот же каталог. Не заменять его стартовым save: миграции в коде поддерживают версии 5–13.
